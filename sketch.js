...
function draw() 
{
  ...
  if(lander.collide(obs)==true||lander.collide(enemyGroup)==true)
  {

    lander.changeAnimation('crashing');
    stop();
    alert("GAME OVER AHHAHAHAHAHAHAH!")
...
function enemiesImg(){
  if(frameCount%20==0){
  var enemy = createSprite(800,800,10,10);
   enemy.y=Math.round(random(0,975));
